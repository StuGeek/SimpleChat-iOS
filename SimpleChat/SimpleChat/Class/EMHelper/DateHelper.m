...
{
    NSDate *date = [DateHelper dateWithTimeIntervalInMilliSecondSince1970:aTimeInterval];
    return [DateHelper formattedTime:date];
}

+ (NSString *)formattedTime:(NSDate *)aDate
{
    DateHelper *helper = [DateHelper shareHelper];
    ...
    NSInteger hour = [DateHelper hoursFromDate:aDate toDate:date];
