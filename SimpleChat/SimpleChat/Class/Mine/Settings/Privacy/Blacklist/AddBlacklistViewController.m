...
@interface AddBlacklistViewController ()<EMSearchBarDelegate, EMAvatarNameCellDelegate>
...
{
    __weak typeof(self) weakself = self;
    [[RealtimeSearch shared] realtimeSearchWithSource:self.contacts searchText:aString collationStringSelector:nil resultBlock:^(NSArray *results) {
