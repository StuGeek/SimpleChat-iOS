//
//  GroupSharedFilesViewController.m
//  SimpleChat
//
...
@interface GroupSharedFilesViewController () <UINavigationControllerDelegate, UIImagePickerControllerDelegate, EMGroupManagerDelegate, UIDocumentPickerDelegate,UIDocumentInteractionControllerDelegate>
...
@implementation GroupSharedFilesViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSString *fileCreateTime = [_dateFormatter stringFromDate:[DateHelper dateWithTimeIntervalInMilliSecondSince1970:file.createTime]];
