...
@interface GroupMutesViewController ()
...
@implementation GroupMutesViewController
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (editingStyle == UITableViewCellEditingStyleDelete) {
        ...
        //hint解除禁言
        ConfirmViewController *confirmControl = [[ConfirmViewController alloc]initWithMembername:userName titleText:@"解除该成员禁言？"];
