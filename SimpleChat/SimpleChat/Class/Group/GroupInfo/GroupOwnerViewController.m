...
@interface GroupOwnerViewController ()<EMSearchBarDelegate, EMAvatarNameCellDelegate>
...
@implementation GroupOwnerViewController
...
- (void)cellAccessoryButtonAction:(EMAvatarNameCell *)aCell
{
    ...
    ConfirmViewController *confirmControl = [[ConfirmViewController alloc]initWithMembername:name titleText:@"是否移交群主给该成员？"];
...
{
    __weak typeof(self) weakself = self;
    [[RealtimeSearch shared] realtimeSearchWithSource:self.dataArray searchText:aString collationStringSelector:nil resultBlock:^(NSArray *results) {
