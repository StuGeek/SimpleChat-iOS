...
@interface GroupsViewController ()<EMGroupManagerDelegate>
...
- (void)searchTextDidChangeWithString:(NSString *)aString
{
    ...
    [[RealtimeSearch shared] realtimeSearchWithSource:self.dataArray searchText:aString collationStringSelector:@selector(subject) resultBlock:^(NSArray *results) {
