...
@interface InviteFriendViewController ()<UITextFieldDelegate, EMSearchBarDelegate, EMAvatarNameCellDelegate>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([blacks containsObject:name]) {
        cell.accessoryButton.enabled = NO;
        [cell.accessoryButton setTitle:@"已拉黑" forState:UIControlStateDisabled];
        cell.accessoryButton.backgroundColor = kColor_Gray;
    } else if ([contacts containsObject:name]) {
        cell.accessoryButton.enabled = NO;
